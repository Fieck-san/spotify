  ...
  return (
    <div className="sidebar">
      ...
      <div className="library-section">
        ...
        <div className="playlist-list scrollbar">
          <div className="playlist-item">
            <div className="playlist-thumbnail"></div>
            <div>
              <div className="playlist-name">My Playlist #1</div>
              <div className="playlist-author">by User</div>
            </div>
          </div>
          <div className="playlist-item">
            <div className="playlist-thumbnail"></div>
            <div>
              <div className="playlist-name">Chill Mix</div>
              <div className="playlist-author">by User</div>
            </div>
          </div>
          <div className="playlist-item">
            <div className="playlist-thumbnail"></div>
            <div>
              <div className="playlist-name">Rock Classics</div>
              <div className="playlist-author">by User</div>
            </div>
          </div>
        </div>
